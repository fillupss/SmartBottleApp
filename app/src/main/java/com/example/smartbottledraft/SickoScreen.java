...
public class SickoScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sicko_screen);
                    ...
                    while(!isInterrupted()){
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if(Integer.parseInt(MyService.getData()) > 375){
                                    updateData();
                                }
                                ...
                                if(currentValue > 17.75){
                                    bottle.setImageResource(R.mipmap.waterbottle4);
                                }
                                else if(currentValue > 16.25){
    ...
    public void startTimer(){
        ...
        countDownTimer = new CountDownTimer(secondsToAlarm, 1000) {
            ...
            public void onFinish() {
                // play sound
                if(player == null){
                    player = MediaPlayer.create(SickoScreen.this, R.raw.sound);
